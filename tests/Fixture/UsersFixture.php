...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'password' => ['type' => 'string', 'length' => 40, 'null' => false, 'default' => null, 'collate' => 'ucs2_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'type' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => null, 'comment' => 'type 1 -> developer

type 2 -> manager

type 3 -> company', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'type' => 1,
            'created' => '2017-04-08 21:23:16',
            'modified' => '2017-04-08 21:23:16'
        ],
    ];
}
